...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.home_btn_2.setLayoutDirection(Qt.LeftToRight)
        self.home_btn_2.setLocale(QLocale(QLocale.Arabic, QLocale.Morocco))
        ...
        self.customers_btn_2.setLayoutDirection(Qt.RightToLeft)
        ...
        self.widget_3.setMaximumSize(QSize(16777214, 16777215))
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icon/icon/menu-4-32.ico", QSize(), QIcon.Normal, QIcon.Off)
        self.change_btn.setIcon(icon8)
        self.change_btn.setIconSize(QSize(14, 14))
        self.change_btn.setCheckable(True)
        # self.change_btn.setLayoutDirection(Qt.RightToLeft)
